...
import type { AdminCourseView, EntityId } from "../../../../shared/types/app.types.js";
...
function AdminCoursesPanel({ adminData, handleAddCourseUser, handleCreateCourse, handleDeleteCourse, handleUpdateCourse }) {
    ...
    const [selectedCourseId, setSelectedCourseId] = useState<EntityId | "new">(adminData.courses[0]?.id ?? "new");
    const [courseToDelete, setCourseToDelete] = useState<AdminCourseView | null>(null);
