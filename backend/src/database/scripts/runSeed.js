...
async function insertClassrooms(client, classrooms) {
...
async function insertCourses(client, courses) {
...
async function insertCourseMembers(client) {
    await client.query(`
...
async function insertDefaultChatChannels(client) {
    await client.query(`
...
async function insertResources(client, resources) {
...
async function insertCalendarEvents(client, calendarEvents) {
...
async function insertClassSessions(client, classSessions) {
...
async function insertAnnouncements(client, announcements) {
