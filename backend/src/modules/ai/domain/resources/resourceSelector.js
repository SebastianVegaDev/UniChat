...
export function getTitleScore(resource, cleanQuestion) {
    let titleScore = 0;
...
export function scoreResource(resource, cleanQuestion, requestedWeeks) {
...
export function selectResources(resources, question) {
...
export function filterResourcesByAnalysis(resources, analysis) {
...
function filterResourcesByCourse(resources, courseFilter) {
