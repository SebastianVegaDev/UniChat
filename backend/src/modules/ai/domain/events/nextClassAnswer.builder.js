import { getDateValue, formatDateTimeLabel, isSameCalendarDay, sortByDate } from "../shared/dateFormatter.js";
...
export function buildNextClassAnswer(classSessions, events, question) {
