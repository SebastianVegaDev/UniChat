...
import type { AiCalendarEvent, AiIntent, QuestionAnalysis } from "../../types/ai.types.js";
import type { CourseFilter } from "../../../../shared/types/domain.types.js";

export function getEventSpecificScore(event: AiCalendarEvent, tokens: readonly string[]): number {
...
export function getEventLine(event: AiCalendarEvent): string {
...
export function getShortEventLine(event: AiCalendarEvent, includeCourse = true): string {
...
export function getEmptyEventsAnswer(intent: AiIntent, courseFilter: CourseFilter | null): string {
...
export function getSpecificEventsEmptyAnswer(intent: AiIntent): string {
    if (intent === "exams") {
...
export function getEventsAnswerTitle(
    intent: AiIntent,
...
export function buildEventsAnswer(
    events: readonly AiCalendarEvent[],
    question: string,
